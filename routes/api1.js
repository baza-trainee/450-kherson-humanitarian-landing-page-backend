...
router.post('/projects', hasValidTocken, isValidProject, controllerProjects.createProject);
router.get('/project/:id', isValidProject, controllerProjects.getProjectById);
router.put('/project', hasValidTocken, isValidProject, controllerProjects.updateProject);
router.delete('/project/:id', hasValidTocken, isValidProject, controllerProjects.deleteProject);
...
router.put('/logo/:id', hasValidTocken, isValidLogo, controllerLogos.updateLogo);
router.delete('/logo/:id', hasValidTocken, isValidLogo, controllerLogos.deleteLogo);

// Contacts routes
router.get('/contacts', controllerContacts.getContacts);
router.put('/contacts', hasValidTocken, isValidContact, controllerContacts.updateContacts);

// Documents routes
router.get('/documents', controllerDocuments.getDocuments);
router.post('/documents/rules', hasValidTocken, controllerDocuments.uploadRules);
router.post(
  '/documents/publicOfferContract',
  hasValidTocken,
  controllerDocuments.uploadPublicOfferContract
);
router.post('/documents/privacy', hasValidTocken, controllerDocuments.uploadPrivacy);
router.post('/documents/statut', hasValidTocken, controllerDocuments.uploadStatut);
router.post('/documents/reporting', hasValidTocken, controllerDocuments.uploadReporting);
