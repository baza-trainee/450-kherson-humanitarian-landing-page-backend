...
const childrenHelpSchema = new Schema(
  {
    name: {
      type: String,
      match: nameRegEx,
...
childrenHelpSchema.post('save', handleSchemaValidationErrors);
...
const addSchema = Joi.object({
  ...
  movementArea: Joi.string()
    .valid(...address.areaCollection)
    .required(),
...
const childrenHelpJoiSchemas = {
  addSchema,
};

const ChildrenHelp = model('childrenHelp', childrenHelpSchema);

module.exports = {
  ChildrenHelp,
  childrenHelpJoiSchemas,
};
